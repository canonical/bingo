...
- Generally, before developing enhancements to this charm, you should consider [opening an issue
  ](https://github.com/canonical/bingo/issues) explaining your use case.
...
- [Fork](https://docs.github.com/en/pull-requests/collaborating-with-pull-requests/working-with-forks/about-forks)
  our [GitHub repository](https://github.com/canonical/bingo)
...
```
git clone https://github.com/canonical/bingo
```
...
OCI image for the bingo app, and then upload the image to a MicroK8s registry,
...
```bash
rockcraft pack
skopeo --insecure-policy copy --dest-tls-verify=false oci-archive:bingo_0.1_amd64.rock docker://localhost:32000/bingo:latest
```
