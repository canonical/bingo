...
myst:
  html_meta:
    "description lang=en": "Familiarize yourself with contributing to the bingo charm documentation."
---
...
```{note}
See [CONTRIBUTING.md](https://github.com/canonical/bingo/blob/main/CONTRIBUTING.md)
for information on contributing to the source code.
```

<!-- TODO(RTD-setup): confirm the Read the Docs link below once the RTD project has been created. -->
Our documentation is hosted on [Read the Docs](https://canonical-bingo-charm.readthedocs-hosted.com/)
...
Our documentation is also available alongside the source code on
[GitHub](https://github.com/canonical/bingo). You may open a pull request with your
documentation changes, or you can [file a bug](https://github.com/canonical/bingo/issues)
...
[Canonical Open Documentation Academy issues](https://github.com/canonical/open-documentation-academy/issues).
...
your contribution in [copilot-collections](https://github.com/canonical/copilot-collections):

* [Documentation instructions](https://github.com/canonical/copilot-collections/tree/main/assets/instructions/documentation)
* [Documentation skills](https://github.com/canonical/copilot-collections/tree/main/assets/skills)
